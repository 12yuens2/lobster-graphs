...
\subsection{Brief qualitative analysis}
...
The classification is first tested on the annotated dataset to see how well it can perform. For unclassified cases, the lobster graph could not be created at all and so the image could not be classified.
\begin{figure}[H]
\centering
\begin{tikzpicture}
\begin{axis}[
    ybar,
    title={\textbf{Classification on annotated dataset}},
    bar width=2em,
...
\addplot coordinates {(Graph method, 0.7) (Label method, 0.55)};
\addlegendentry{Correct}

\addplot coordinates {(Graph method, 0.15) (Label method, 0.3)};
\addlegendentry{Incorrect}

\addplot coordinates {(Graph method, 0.15) (Label method, 0.15)};
\addlegendentry{Unclassified}
\end{axis}
\end{tikzpicture}
\caption{Overall classification rate on annotated images}
\end{figure}
\noindent
...
\addplot coordinates {(Graph method, 0.8) (Label method, 0.6)};
\addlegendentry{Correct}

\addplot coordinates {(Graph method, 0.2) (Label method, 0.4)};
\addlegendentry{Incorrect}

\addplot coordinates {(Graph method, 0) (Label method, 0)};
\addlegendentry{Unclassified}
\end{axis}
\end{tikzpicture}
\end{minipage}
...
\addplot coordinates {(Graph method, 0.6) (Label method, 0.5)};
\addlegendentry{Correct}

\addplot coordinates {(Graph method, 0.1) (Label method, 0.2)};
\addlegendentry{Incorrect}
...
\addplot coordinates {(Graph method, 0.497) (Label method, 0.508)};
\addlegendentry{Correct}

\addplot coordinates {(Graph method, 0.183) (Label method, 0.172)};
\addlegendentry{Incorrect}

\addplot coordinates {(Graph method, 0.32) (Label method, 0.32)};
\addlegendentry{Unclassified}
\end{axis}
\end{tikzpicture}
...
\end{figure}
\noindent
These results are important for finding the areas of weakness in this graph matching approach to correct them for any future work. Having the distinct difference of weaknesses between the juvenile and mature lobsters allows focused evaluation on why each category was stronger and weaker in different aspects.
