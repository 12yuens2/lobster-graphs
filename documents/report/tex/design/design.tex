...
\n
In the end, simpler representations such as the one in figure \ref{fig:gephi-simple} were chosen because the simplicity allowed for more robust probability models. TODO
\n
